...
public class DbHandler extends SQLiteOpenHelper {
    ...
    */
    ...
    //software/database
    Module COMP605 = new Module("COMP605", "Data Structures and Algorithms", 6, 15, "COMP601, MATH601", "none", 2, "Software Engineering,Databases", "To enable students to apply programming and analytical skills to implement and analyze common data structures for computer programs. Students will cover a wide range of computer programming algorithms.");
    ...
    Module COMP709 = new Module("COMP709", "Mobile Applications Development",7,15, "COMP601, MATH601", "none", 3, "Web Development,Software Engineering,Databases", "To enable students to design, develop and implement mobile applications on a given platform.");
    Module COMP710 = new Module("COMP710", "Web Applications Development",7,15, "COMP602, COMP606", "none", 3, "Web Development", "To enable students to apply practical knowledge of Model View Controller (MVC) frameworks to plan, design and implement web applications. The core focus will be on architecture design and implementation of a web application that will meet a set of functional requirements and user interface requirements, and address business models.");
    ...
    Module COMP701 = new Module("COMP701", "Advanced Networking",7,15, "INFO603", "none", 3, "Networking", "To enable students to investigate and configure advanced system administration tools, advanced network virtualisation and wireless networking technologies. Students will also research emerging networking technologies.");
    ...
    Module COMP714 = new Module("COMP714 / INFO710 / DFNZ701", "Network Engineering Project / Internship / Design Factory", 7,30,"COMP701, COMP702, COMP704", "none", 3, "Networking", "To enable students to further develop their knowledge of Web Applications by analysing, designing and implementing a web solution. This module is the Web Application Capstone Project.");
    ...
    Module INFO703 = new Module("INFO703", "Big Data and Analytics",7,15, "COMP605, MATH601", "none", 3, "Software Engineering,Databases", "To enable students to gain the practical knowledge and skills required to store, manage and analyse large amounts of data, using appropriate algorithms.");
